stat_cast <- R6::R6Class('stat_cast_data',
            private = list(
              ...
              hit_fields = c("pitch_type","game_date","release_speed","player_name" ,"batter",                          
                             "pitcher", "spin_dir" ,"zone", "des" , "stand" ,"p_throws" ,"home_team",
                             "away_team","type" ,"hit_location","bb_type","balls","strikes", "plate_x",
                             "outs_when_up", "inning", "inning_topbot","hc_x","hc_y","sv_id","vx0","vy0","vz0" ,                           
                             ...
                             "pitch_number" ,"pitch_name" ,"in_zone", "plate_x", "plate_z")
